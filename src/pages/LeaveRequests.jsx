                        ...
                        return (
                          ...
                          >
                            ...
                            <td className="py-1">
                              <button
                                onClick={() =>
                                  updateClickHandler(leave._id, "approved")
                                }
                                className="bg-green-700 text-white py-1 rounded-full inline-block min-w-24 cursor-pointer hover:bg-green-800"
                              >
                                Approve
                              </button>
                            </td>
                            <td className="py-1">
                              <button
                                onClick={() =>
                                  updateClickHandler(leave._id, "rejected")
                                }
                                className="bg-red-700 text-white  py-1 rounded-full inline-block min-w-24 cursor-pointer hover:bg-red-800"
                              >
                                Reject
                              </button>
                            </td>
